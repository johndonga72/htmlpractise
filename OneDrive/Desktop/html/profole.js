...
function ProfileForm() {
    ...
    useEffect(() => {
        ...
        axios.get("http://127.0.0.1:8000/api1/profile/", {
            ...
            .then(res => {
                if (res.data) {
                    // ✅ ensure educations & experiences are always arrays
                    setProfile({
                        ...res.data,
                        educations: Array.isArray(res.data.educations) && res.data.educations.length > 0
                            ? res.data.educations
                            : [{ degree: "", university: "", year_of_completion: "", marks_cgpa: "" }],
                        experiences: Array.isArray(res.data.experiences) && res.data.experiences.length > 0
